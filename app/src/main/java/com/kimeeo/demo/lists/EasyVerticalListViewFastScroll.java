 ...
 */
public class EasyVerticalListViewFastScroll extends DefaultVerticalListView
{
    ...
    protected View createRootView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout._fragment_recycler_fast_scroll, container, false);
        return rootView;
    }
