...
import com.kimeeo.library.listDataView.listViews.stackView.DefaultStackView;
 ...
 */
public class StackView extends DefaultStackView implements DefaultProjectDataManager.IDataManagerDelegate
{
    // Data Manager
